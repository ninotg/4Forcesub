...
# Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001929827203"))
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://ginopew837:ginopew837@cluster0.ebp1fwc.mongodb.net/?retryWrites=true&w=majority")
