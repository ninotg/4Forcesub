...
# Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "YOUR_CHANNEL_ID_HERE"))

# OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "YOUR_OWNER_ID_HERE"))

# Port
PORT = os.environ.get("PORT", "8080")

# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://username:password@cluster.mongodb.net/dbname")
